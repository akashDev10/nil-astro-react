...
const AddPlanetDeatils = (props) => {

    const [planet, setPlanetNo] = useState("SU");
    const [lowDate, setLowerDate] = useState('');
    const [lowSphoot, setLowerLongitudeOfPlanet] = useState('');
    const [highDate, setHigherLatitude] = useState('');
    const [highSphoot, setHigherLongitudeOfPlanet] = useState('');
...
export default AddPlanetDeatils;